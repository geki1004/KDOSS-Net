...
def test(model, opt):#mat_model,
    ...
    test_data = KD_semantic_segmentation_Dataset(opt.data_dir, resize=512, targetresize=True, direction='top', cover_percent=0.1) #semantic_segmentation_Dataset(opt.data_dir, resize=512, targetresize=True) #
    ...
    for input_img, mask_img, b_mask, T, filename in tqdm(testloader):#
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='C:/Users/shc01/Downloads/data/cropweed_total/IJRR2017/occ/KD_2/test', help='directory that has data')#C:/Users/shc/Downloads/data/cropweed_total/IJRR2017/occ/1/test
    parser.add_argument('--save_dir', type=str, default='D:/save/bonirob/KD/mobunet', help='directory for saving results')
    parser.add_argument('--weights', type=str, default='D:/save/bonirob/KD/mobunet/MobileUNet-ep400-train-2-1/ckpoints/best_miou.pth', help='weights file for test') #C:/Users/shc/Downloads/save/seg/good/Unet-ep400-train_mat-1-ce/ckpoints/model_last.pth C:/Users/shc/Downloads/save/seg/good/Unet-ep400-train-1-512/ckpoints/best_miou.pth
    ...
    parser.add_argument('--model', type=str, default='munet', help='modelname')
    parser.add_argument('--num_classes', type=int, default=3, help='the number of classes')
    opt = parser.parse_args()
    assert opt.model in ['munet'], 'opt.model is not available'
