...
class ResNet50(nn.Module):
    def __init__(self, in_channels=3, num_classes=1000, zero_init_residual=False,
...
class Resnet50_DeepLabv3Plus(nn.Module):
    def __init__(self, in_channels=3, num_classes=3, output_stride=8, pretrained=False):
        super().__init__()
        ...
        backbone = ResNet50(in_channels=in_channels, replace_stride_with_dilation=replace_stride_with_dilation, pretrained=pretrained)
