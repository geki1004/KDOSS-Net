...
import models
from dataset import blind_semantic_segmentation_Dataset, semantic_segmentation_Dataset
...
class Trainer():
    def __init__(self, opt, cfg, model):
        ...
        train_dataset = semantic_segmentation_Dataset(train_dir, resize=cfg['RESIZE'], targetresize=True, randomaug=None)
        val_dataset = semantic_segmentation_Dataset(os.path.join(cfg['DATA_DIR'], 'test'), resize=cfg['RESIZE'], targetresize=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/semantic_segmentation_config.yaml', help='yaml file that has segmentation train config information')
